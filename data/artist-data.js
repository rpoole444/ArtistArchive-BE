const artists = [
  ...
  },
  {
    ...
    rank: 22,
    description:
      "Yo-Yo Ma (born 1955) is a Chinese-American cellist and composer who has become one of the world's most celebrated classical musicians. He began learning to play the cello at age four and later studied at the Juilliard School in New York City. Throughout his career he has performed with some of the leading orchestras around the world while also playing solo concerts. Yo-Yo Ma has also been active in recording, having released over 80 albums which have sold millions of copies worldwide. His repertoire spans many genres including classical, jazz, folk music, pop, rock and more. In addition to being recognized as a masterful performer on stage, Yo-Yo Ma is an advocate for arts education and cultural understanding through his various initiatives. He is remembered as one of the greatest cellists of all time.",
    genre: "Classical",
    video: "3uiUHvET_jg",
  },
  {
  ...
  },
  {
    ...
    rank: 27,
    description:
      "The Bad Plus (formed in 2000) is an American jazz trio who are widely considered to be one of the most influential groups in modern music. Comprised of members Reid Anderson, Dave King, and Ethan Iverson, The Bad Plus have released over a dozen albums which showcase their unique sound blending elements from various genres such as rock, pop, classical and more while also exploring themes such as love, loss and identity. In addition to being recognized for their musical talent, The Bad Plus are also advocates for social justice issues through initiatives such as Jazz4Justice. Their influence continues today through both their recordings and legacy making them one of the most important groups in contemporary jazz.",
  ...
  },
  {
    ...
    rank: 28,
    description:
      "Charlie Parker (1920-1955) was an American jazz saxophonist and composer who is widely considered to be one of the most influential figures in modern music. He developed an early interest in music, eventually studying with some of the leading musicians in Kansas City before embarking on a career that spanned several decades. His recordings showcased his unique approach to improvisation which utilized elements from various genres such as blues, classical, and Latin while also exploring themes such as race and identity. In addition to being recognized for his musical talent, Charlie Parker was also an advocate for social justice issues through initiatives such as The Jazz Foundation of America. His influence continues today through both his recordings and legacy making him one of the most important figures in jazz history",
    genre: "Jazz",
    video: "DmRkZeGFONg",
  },
  {
